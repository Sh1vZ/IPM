                ...
                ajax.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        for(var a = 0; a < data.length; a++) {
                            ...
                            html += "<tr><td>" + Achternaam +  " " + Voornaam + "</td><td>" + "SRD " + Bedrag + "</td><td>" + Datum + "</td><td><form method='post'><button class='btn btn-primary' type='submit' name='Acc'>Accept</button></form></td></tr>";
